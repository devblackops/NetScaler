...
FunctionsToExport = 'Add-NSCertKeyPair', 'Add-NSDnsNameServer', 'Add-NSIPResource', 
               ...
               'Enable-NSLBVirtualServer', 'Enable-NSMode', 
               'Get-NSAvailableTimeZone', 'Get-NSConfig', 'Get-NSFeature', 
               'Get-NSHostname', 'Get-NSLBMonitor', 'Get-NSLBServer', 
               'Get-NSLBServiceGroup', 'Get-NSLBServiceGroupMemberBinding', 
               'Get-NSLBStat', 'Get-NSLBVirtualServer', 
               'Get-NSLBVirtualServerBinding', 'Get-NSResponderAction', 'Get-NSMode', 
               'Install-NSLicense', 'Invoke-Nitro', 'New-NSLBMonitor',
               'New-NSKCDAccount',
               'New-NSLBServer', 'New-NSLBServiceGroup', 
               'New-NSLBServiceGroupMember', 'New-NSLBVirtualServer', 
               'New-NSNTPServer', 
               'New-NSResponderAction', 'Remove-NSLBMonitor', 'Remove-NSLBServer', 
               'Remove-NSLBServiceGroup', 'Remove-NSLBVirtualServer', 
               'Remove-NSLBVirtualServerBinding', 'Remove-NSResponderAction', 
               'Restart-NetScaler', 'Save-NSConfig', 'Set-NSHostname', 
               'Set-NSLBServer', 'Set-NSLBServiceGroup', 'Set-NSLBVirtualServer', 
               'Set-NSResponderAction', 'Set-NSTimeZone'
